...
const nav = [
  ...
  },
  {
    section: "Control",
    items: [
      { href: "/dashboard/integrations", label: "Integrations", icon: "M9 3v4M15 3v4M7 7h10a2 2 0 012 2v2a7 7 0 01-14 0V9a2 2 0 012-2zM12 18v3" },
      { href: "/dashboard/memory", label: "Memory", icon: "M12 4a4 4 0 014 4c2 .5 3.5 2.2 3.5 4.4 0 1.7-.9 3.1-2.2 3.9L17 21h-4M12 4a4 4 0 00-4 4c-2 .5-3.5 2.2-3.5 4.4 0 1.7.9 3.1 2.2 3.9L7 21h4M12 4v17" },
      { href: "/dashboard/audit", label: "Audit logs", icon: "M7 3h10a2 2 0 012 2v14a2 2 0 01-2 2H7a2 2 0 01-2-2V5a2 2 0 012-2zM9 8h6M9 12h6M9 16h4" },
    ],
  },
  {
    section: "Account",
    ...
    <div className="border-t border-ink-100 p-4">
      <div className="flex items-center gap-3">
        ...
        <div className="min-w-0">
          <p className="truncate text-sm font-medium text-ink-950">Jake Ontiveros</p>
          <p className="truncate text-xs text-ink-400">Everflow Acquisitions · Team</p>
        </div>
        <Link href="/" className="ml-auto text-ink-400 hover:text-ink-700" aria-label="Log out">
